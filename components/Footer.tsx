    ...
    <footer>
      <div className="bg-[#111827] text-white">
            ...
            <div className="sm:col-span-2 lg:col-span-1 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-1">
                <a
                  ...
                  aria-label="Sitaram Hospital on Facebook"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Sitaram Hospital on Instagram"
                  className="w-9 h-9 rounded-full flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
        ...
        <div className="border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-white/30 text-xs">
            <span>{f.rights}</span>
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="text-white/30 hover:text-[#d6249f] transition-colors"
              >
                <InstagramIcon />
              </a>
